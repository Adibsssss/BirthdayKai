    ...
    <main className="min-h-screen bg-paper pb-32">
      <header className="glass-surface sticky top-0 z-20 px-4 py-3">
        <div className="mx-auto flex max-w-6xl items-center gap-2.5">
          <span
            className="flex h-8 w-8 items-center justify-center rounded-full bg-coral text-sm"
            aria-hidden
          >
            ✦
          </span>
      ...
      <section className="mx-auto max-w-6xl px-4 pt-8 sm:px-6 sm:pt-12">
        <div className="rounded-[2rem] bg-ink px-6 py-9 text-paper sm:px-10 sm:py-12">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-peach">
            One beautiful day
          </p>
          <h1 className="mt-3 font-display text-4xl leading-[0.98] sm:text-6xl">
