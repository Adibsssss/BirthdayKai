...
export function PhotoCard({ photo, onOpen, isNew = false }: PhotoCardProps) {
  ...
  return (
    <button
      ...
      className={`group relative mb-4 block w-full break-inside-avoid rounded-sm polaroid-frame rotate-[var(--tilt)] transition-transform duration-300 hover:z-10 hover:rotate-0 hover:-translate-y-1 sm:mb-5 ${
